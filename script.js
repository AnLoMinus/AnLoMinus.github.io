    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        if (pin === Default.PIN) {
          ...
          reject(`Hello You Entered Invalid PIN: ${pin}`);
        }
      }, N.rand(300, 700));
    });
  }
...
const Pin = () => {
  ...
  return React.createElement(
    ...
    React.createElement("input", {
      disabled: userStatus !== UserStatus.LoggingIn &&
        userStatus !== UserStatus.LogInError,
    ...
    React.createElement(
      ...
      React.createElement(PinDigit, {
        focused: pin.length === 6,
        value: pin[6]
      }),
      React.createElement(PinDigit, {
        focused: pin.length === 7,
        value: pin[7]
      }),
      React.createElement(PinDigit, {
        focused: pin.length === 8,
        value: pin[8]
      })
    ),
    React.createElement(
...
const Restaurants = () => {
  const getRestaurants = () => {
    return [{
        ...
        image: "https://user-images.githubusercontent.com/51442719/170010336-39176f7e-b5dc-4f31-81ca-4b4144e6938c.png"
      },
      {
